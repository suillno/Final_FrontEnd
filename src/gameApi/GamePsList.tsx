...
const MainTitle = styled.h2<{ $isSidebarOpen: boolean }>`
  ...
  transition: margin-left 0.3s ease;
  background: linear-gradient(90deg, #003791, #003791);
...
const GamePsList: React.FC = () => {
  ...
  return (
    <div className="bg-[#1e1f24] text-white py-6 w-full mt-10">
      {/* 상단 제목 */}
      <MainTitle $isSidebarOpen={isSidebarOpen}>🔵 PlayStation</MainTitle>
